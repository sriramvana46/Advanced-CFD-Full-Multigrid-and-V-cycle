...
int main()
{
    ...
    ofstream outfile("Vcycle_Results.txt");
    ...
    cout << "Results printed in Vcycle_Results.txt file." << endl;
    ...
    outfile << "Residual two Norm of the velocities in the last Vcycle is: " << endl;
    outfile << norm << endl;

    outfile << "Total iterations in V cycle for convergence is: " << endl;
